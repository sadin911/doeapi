...
from tensorflow.keras.layers import Input, Dense, Activation , LeakyReLU, Flatten, BatchNormalization, Dropout
...
path_input = r'/home/chonlatid/py_project/Office Lens/**/*.jpg'
#path_input = r'/home/chonlatid/py_project/4corner/images/input/*.jpg'
bg_path = r'/home/chonlatid/py_project/4corner/images/background/**/*.png'
...
#                sys.stdout.write(ERASE_LINE)
                ...
                if(step_index % viz_interval == 0): 
                    self.model.save_weights('checkpoint_lr5_1img.h5')
                    viz_img = self.plot_corner(img_viz,predict_corner)
                    gt_img = self.plot_corner(img_viz,target)
                    try:
...
if __name__ == '__main__':
    ...
    #cor.model.load_weights(r'checkpoint_lr5_1img.h5')
#    cor.viz_result('test',6)
    cor.train(1,10000000,4,10)
